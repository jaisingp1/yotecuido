        ...
        <div className="w-full max-w-md">
          <Card>
            <CardHeader className="space-y-1 text-center">
              ...
              <CardDescription>Ingresa a tu cuenta para gestionar tus servicios</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="mt-4 rounded-lg bg-sky-50 p-3 text-center">
                <p className="text-xs text-muted-foreground">
                  <strong>Demo:</strong> Usa cualquier email de{" "}
                  <Link href="/demo" className="text-primary hover:underline">
                    la página demo
                  </Link>{" "}
                  con contraseña "demo123"
                </p>
              </div>
            </CardContent>
          </Card>
